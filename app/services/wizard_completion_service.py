...
class WizardCompletionService:
    ...
    def _build_voice_settings(self, step_data: Dict[str, Any]) -> VoiceSettings:
        ...
        # Enable dynamic emotion expression for Cartesia Sonic-3 by default
        emotions_enabled = tts_provider == "cartesia" and tts_model == "sonic-3"
        ...
        return VoiceSettings(
            ...
            llm_model=llm_model,
            temperature=0.7,
            cartesia_emotions_enabled=emotions_enabled,
        )
