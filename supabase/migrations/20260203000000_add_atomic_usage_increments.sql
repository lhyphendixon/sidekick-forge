-- Migration: Add atomic increment functions for usage tracking
-- This prevents race conditions where concurrent requests could lose increments
-- Date: 2026-02-03

-- ============================================================================
-- Atomic increment for agent voice usage
-- ============================================================================
...
BEGIN
    ...
    LEFT JOIN public.tier_quotas tq ON tq.tier = COALESCE(c.tier, 'adventurer')
