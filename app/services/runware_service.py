...
class RunWareService:
    ...
    async def generate_image_advanced(
        ...
        *,
        ...
        Supports Google/Gemini (google:4@2) with referenceImages,
        GPT Image 1.5 (openai:4@1) with referenceImages and quality tiers,
        ...
        is_google_model = model.startswith("google:")
        ...
        if is_gpt_model:
            ...
            # Google/Gemini models (e.g. google:4@2 Nano Banana 2 Pro)
            # Support referenceImages for image-to-image
            if reference_images:
                payload["referenceImages"] = reference_images
        else:
