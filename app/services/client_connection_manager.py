...
class ClientConnectionManager:
    ...
    def get_client_api_keys(self, client_id: UUID) -> Dict[str, Optional[str]]:
        ...
        api_keys = {
            ...
            'inworld_api_key': client_config.get('inworld_api_key'),
            'fish_audio_api_key': client_config.get('fish_audio_api_key'),
            'bithuman_api_secret': client_config.get('bithuman_api_secret'),
            'bey_api_key': client_config.get('bey_api_key'),
            'liveavatar_api_key': client_config.get('liveavatar_api_key'),
