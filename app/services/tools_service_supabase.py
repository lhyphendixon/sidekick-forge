    ...
    def _ensure_default_global_tools(self) -> None:
        ...
        default_tools = [
            ...
            },
            {
                "name": "Evernote Notes",
                "slug": "evernote_notes",
                "description": "Access and manage Evernote notes and notebooks. Search, read, create, and update notes.",
                "type": "evernote",
                "scope": "global",
                "client_id": None,
                "icon_url": "/static/images/abilities/evernote.svg",
                "config": {
                    "sandbox": False,
            ...
            },
            {
                "name": "Trello Boards",
                "slug": "trello_boards",
                "description": "Access and manage Trello boards, lists, and cards. Search, create, update, move, and delete cards.",
                "type": "trello",
                "scope": "global",
                "client_id": None,
                "icon_url": "/static/images/abilities/trello.svg",
                "config": {
                    "boards": [],
                    "default_action": "list",
                },
            ...
            },
            {
                ...
                "description": "Access and manage Notion databases and pages. Search, query, create, update, and archive pages.",
                "type": "notion",
                "scope": "global",
                "client_id": None,
                "icon_url": "/static/images/abilities/notion.svg",
                "config": {
                    "databases": [],
                    "default_action": "list",
            ...
            {
                "name": "Descript Connect",
                "slug": "descript_connect",
                "description": "AI-powered video editing via Descript. Upload videos, remove filler words and silences, enhance audio with Studio Sound, generate captions, and create highlight clips.",
                "type": "descript",
                "scope": "global",
                "client_id": None,
                "icon_url": "/static/images/abilities/descript.svg",
                "config": {},
                "enabled": False,
            },
            {
                "name": "Semrush SEO",
                "slug": "semrush",
                "description": "Search and analyze SEO data using Semrush. Get keyword research, domain analytics, competitor analysis, backlink data, traffic insights, site audits, and more. Powered by 60+ Semrush API tools via MCP.",
                "type": "semrush",
                "scope": "global",
                "client_id": None,
                "icon_url": "/static/images/abilities/semrush.svg",
                "config": {},
                "enabled": False,
            },
            {
                "name": "Content Recon",
                "slug": "content_recon",
                "description": "SEO intelligence powered by Ahrefs. Analyze domains, research keywords, audit backlinks, track competitors, explore SERPs, and uncover content opportunities with 42+ data tools.",
                "type": "ahrefs",
                "scope": "global",
                "client_id": None,
                "icon_url": "/static/images/abilities/content-recon.svg",
                "config": {},
                "enabled": False,
            },
            {
                "name": "Campaign Scan",
                "slug": "campaign_scan",
                "description": "Review emails and newsletters for typos, errors, visual issues, subject line effectiveness, CTA clarity, mobile responsiveness, and deliverability. Forward an email to your sidekick for a detailed analysis.",
                "type": "campaign_scan",
                "scope": "global",
                "client_id": None,
                "icon_url": "/static/images/abilities/campaign-scan.svg",
                "config": {},
                "enabled": True,
            },
        ]
