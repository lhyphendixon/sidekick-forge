...
class ClientService:
    ...
    def _parse_client_data(self, client_data: Dict[str, Any]) -> Client:
        ...
        api_keys = APIKeys(
            ...
            inworld_api_key=client_data.get("inworld_api_key"),
            fish_audio_api_key=client_data.get("fish_audio_api_key"),
            bithuman_api_secret=client_data.get("bithuman_api_secret"),
            bey_api_key=client_data.get("bey_api_key"),
            liveavatar_api_key=client_data.get("liveavatar_api_key"),
        ...
        try:
            ...
            if client_data.settings and client_data.settings.api_keys:
                ...
                data.update({
                    ...
                    "inworld_api_key": getattr(keys, "inworld_api_key", None),
