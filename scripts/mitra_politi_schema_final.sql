-- Mitra Politi Database Schema Setup (FINAL FIXED VERSION)
...
-- IMPORTANT: Only using 1024-dimensional vectors to avoid ivfflat issues
CREATE TABLE IF NOT EXISTS documents (
    ...
    embeddings vector(1024),  -- Primary embedding column (1024 dimensions)
...
BEGIN
    ...
    RAISE NOTICE 'All vector embeddings are using 1024 dimensions (within ivfflat limit).';
END $$;