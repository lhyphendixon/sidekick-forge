#!/usr/bin/env python3
"""
Test text chat storage with UUID conversation ID
"""
...
async def test_text_chat_storage():
    ...
    print(f"🧪 Testing Text Chat Storage with UUID conversation_id: {unique_conv_id}")
    
    payload = {
        "message": "Hello! Testing storage with a proper UUID conversation ID.",
